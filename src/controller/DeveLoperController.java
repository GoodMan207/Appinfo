...
public class DeveLoperController {
	...
	public String getAppInfoList(Model model,HttpSession session,
		...
		return "backend/developer/appinfolist";
	}
	...
	@ResponseBody
	public List<Dictionary> getDataDicList (@RequestParam String tcode){
	...
	public String add(@ModelAttribute("appInfo") Info appInfo){
		return "backend/developer/appinfoadd";
	}
	...
	public String addSave(Info appInfo,HttpSession session,HttpServletRequest request,
	...
	public String addVersion(@RequestParam(value="id")String appId,
		...
		return "backend/developer/appversionadd";
	}
	/**
	...
	public String view(@PathVariable String id,Model model){
		...
		return "backend/developer/appinfoview";
	}
	...
	public String modifyAppInfo(@RequestParam("id") String id,
		...
		model.addAttribute("appInfo",appInfo);
		model.addAttribute("fileUploadError",fileUploadError);
		return "backend/developer/appinfomodify";
	}
	...
	public String modifyAppVersion(@RequestParam("vid") String versionId,
		...
		model.addAttribute("fileUploadError",fileUploadError);
		return "backend/developer/appversionmodify";
	}
	...
	public String modifySave(Info appInfo,HttpSession session,HttpServletRequest request,
							@RequestParam(value="attach",required= false) MultipartFile attach){		
		String logoPicPath =  null;
		String logoLocPath =  null;
		...
		appInfo.setLogoLocPath(logoLocPath);
		appInfo.setLogoPicPath(logoPicPath);
		if(appInfo.getStatusName().equals("待审核")) {
			appInfo.setStatus(1);
		}else if(appInfo.getStatusName().equals("审核通过")) {
			appInfo.setStatus(2);
		}else  if(appInfo.getStatusName().equals("审核未通过")){
			appInfo.setStatus(3);
		}else if(appInfo.getStatusName().equals("已上架")){
			appInfo.setStatus(4);
		}else if(appInfo.getStatusName().equals("已下架")){
			appInfo.setStatus(5);
		}
